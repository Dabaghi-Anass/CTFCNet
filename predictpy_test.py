...
from utils1.utils import eval_all
...
class PredOption():
    ...
    def initialize(self, parser):
        parser.add_argument('--pred_batch_size', required=False, default=8, type=int, help='prediction batch size')
        ...
        parser.add_argument('--chkpt_path', required=False, default='./', help='checkpoints path')
...
def main():
    ...
    predict(model, data_test, test_loader, opt.pred_dir, device)


def predict(net, pred_set, pred_loader, pred_dir, device):
